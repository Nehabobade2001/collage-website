...
export default function Footer() {
  ...
  return (
    <footer style={{ background: "#000" }} className="text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-14 text-center">
          ...
          >
            ...
            <div className="flex items-center justify-center gap-2 mb-4">
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.3em]" style={{ color: "rgba(255,255,255,0.6)" }}>
                Enroll Today
              </span>
            </div>
            ...
            >
              Study at a{" "}
              <span style={{ color: "#fbbf24" }}>Govt. Recognised</span> Institution
            </h2>

            {/* Sub text */}
            <p className="text-sm max-w-lg mx-auto mb-8" style={{ color: "rgba(255,255,255,0.7)" }}>
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <motion.a
                ...
                whileTap={{ scale: 0.96 }}
                className="inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-lg font-bold text-sm text-red-600 uppercase tracking-wider"
              ...
              <motion.a
                href="#"
                whileHover={{ scale: 1.06, y: -2, backgroundColor: "rgba(255,255,255,0.15)" }}
                whileTap={{ scale: 0.96 }}
                className="inline-flex items-center justify-center gap-2 px-8 py-3.5 border-2 border-white/50 text-white font-bold text-sm uppercase tracking-wider rounded-lg transition-colors duration-200"
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          >
            <div className="flex items-center gap-6 mb-5">
              ...
              <div>
                <div className="font-black text-white text-2xl tracking-tight leading-none">AIIMES</div>
                <div className="text-[9px] uppercase tracking-[0.16em] text-white/60 mt-1 leading-tight">
                  All India Institute of Management<br />& Engineering Studies
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-2 flex-wrap">
              {socials.map((s, i) => (
                <motion.a key={s.label} href="#" aria-label={s.label}
                  ...
                  whileHover={{ scale: 1.15, y: -4, backgroundColor: "#dc2626", borderColor: "#dc2626", color: "#fff" }}
                  whileTap={{ scale: 0.92 }}
                  className="w-9 h-9 rounded-lg border border-white/10 text-white/50 flex items-center justify-center transition-all duration-200">
                  {s.icon}
                </motion.a>
              ))}
            </div>
                  ...
                  {col.items.map((item, i) => (
                    ...
                    >
                      <motion.a href="#"
                        whileHover={{ x: 5, color: "#ef4444" }}
                        transition={{ duration: 0.15 }}
                        className="text-white/50 text-sm flex items-center gap-2.5 transition-colors duration-200">
                        <Arr /> {item}
                      </motion.a>
                    </motion.li>
                  ))}
          ...
          {offices.map((office, oi) => (
            ...
            >
              <div className="flex items-center gap-3 mb-5">
                ...
                <div>
                  <div className="text-white font-bold text-base leading-none">{office.country}</div>
                  <div className="text-white/50 text-[12px] mt-0.5">{office.flag} International Office</div>
                </div>
                <motion.div className="flex-1 h-px bg-white/5 ml-2" />
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pl-1">
                <div className="flex items-start gap-2.5">
                  ...
                  <div>
                    <p className="text-[10px] uppercase tracking-[0.18em] text-white/40 font-bold mb-1">Address</p>
                    <p className="text-white/70 text-[12px] leading-relaxed">{office.address}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2.5">
                  ...
                  <div>
                    <p className="text-[10px] uppercase tracking-[0.18em] text-white/40 font-bold mb-1">Phone</p>
                    <motion.a href={`tel:${office.phone}`} whileHover={{ color: "#ef4444" }}
                      className="text-white/70 text-xs font-semibold transition-colors duration-200">
                      {office.phone}
                    </motion.a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2.5">
                  ...
                  <div>
                    <p className="text-[9px] uppercase tracking-[0.18em] text-white/40 font-bold mb-1">Email</p>
                    <motion.a href={`mailto:${office.email}`} whileHover={{ color: "#ef4444" }}
                      className="text-white/70 text-xs font-semibold transition-colors duration-200">
                      {office.email}
                    </motion.a>
                  </div>
      ...
      <div style={{ borderTop: "1px solid #1c1c1c", background: "#0a0a0a" }}>
        <div className="max-w-7xl mx-auto px-6 py-5 flex flex-col md:flex-row items-center justify-between gap-3">
          <motion.p className="text-white/40 text-[14px] text-center md:text-left"
            initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5, delay: 0.5 }}
          >
            © {new Date().getFullYear()}{" "}
            <span className="text-white/70 font-semibold">AIIMES</span> — All India Institute of
            Management & Engineering Studies. All rights reserved.
          </motion.p>
          <div className="flex items-center gap-4">
            {["Privacy Policy", "Terms of Use", "Sitemap"].map((item, i) => (
              <motion.a key={item} href="#"
                ...
                transition={{ duration: 0.35, delay: 0.55 + i * 0.08 }}
                whileHover={{ color: "#dc2626", y: -1 }}
                className="text-white/40 text-xs transition-colors duration-200">
                {item}
              </motion.a>
            ))}
          </div>
